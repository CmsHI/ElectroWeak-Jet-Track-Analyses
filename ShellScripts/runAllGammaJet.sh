...
# hadd ${OUTDIR}/PbPb_Data_gammaJetHistogram.root ${H_INDIR}/PbPb_Data_gammaJetHistogram_unmerged/*.root
# rm ${H_INDIR}/PbPb_Data_gammaJetHistogram_unmerged/*.root

# hadd ${OUTDIR}/PbPb_MC_gammaJetHistogram.root ${H_INDIR}/PbPb_MC_gammaJetHistogram_unmerged/*.root
# rm ${H_INDIR}/PbPb_MC_gammaJetHistogram_unmerged/*.root

# hadd ${OUTDIR}/pp_Data_gammaJetHistogram.root ${H_INDIR}/pp_Data_gammaJetHistogram_unmerged/*.root
# rm ${H_INDIR}/pp_Data_gammaJetHistogram_unmerged/*.root

# hadd ${OUTDIR}/pp_MC_gammaJetHistogram.root ${H_INDIR}/pp_MC_gammaJetHistogram_unmerged/*.root
