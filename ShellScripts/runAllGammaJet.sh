...
# time ./Performance/JES_Fitting.exe ./CutConfigurations/gammaJet_mc_JES_DOWN.conf ${OUTDIR}/PbPb_MC_gammaJetHistogram_JES_DOWN.root ${OUTDIR}/PbPb_MC_gammaJetHistogram_xjg_JES_DOWN.root > ${OUTDIR}/PbPb_MC_gammaJetHistogram_xjg_JES_DOWN.root.log &

# time ./Performance/JES_Fitting.exe ./CutConfigurations/gammaJet_pp_JES_DOWN.conf ${OUTDIR}/pp_Data_gammaJetHistogram_JES_DOWN.root ${OUTDIR}/pp_Data_gammaJetHistogram_xjg_JES_DOWN.root > ${OUTDIR}/pp_Data_gammaJetHistogram_xjg_JES_DOWN.root.log &

# time ./Performance/JES_Fitting.exe ./CutConfigurations/gammaJet_pp_mc_JES_DOWN.conf ${OUTDIR}/pp_MC_gammaJetHistogram_JES_DOWN.root ${OUTDIR}/pp_MC_gammaJetHistogram_xjg_JES_DOWN.root > ${OUTDIR}/pp_MC_gammaJetHistogram_xjg_JES_DOWN.root.log &
