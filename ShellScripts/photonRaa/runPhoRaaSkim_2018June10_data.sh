...
echo "### pp DATA (Lowpt) ###"
INFILE=./ShellScripts/photonRaa/pp/pp_Data_HiForest_HighPtLowerPhotons.list
OUTMCSKIM=pp_Data_photonRaaSkim_Lowpt.root
CONFIG=./CutConfigurations/photonRaaLowpt_pp.conf
time ./ForestSkimmers/photons/photonRaaSkim_workingOn.exe ${CONFIG} ${INFILE} ${OUTDIR}/${OUTMCSKIM} > ${OUTDIR}/${OUTMCSKIM}.log || echo "ERROR"

#echo "### PbPb DATA (Lowpt)###"
#INFILE=./ShellScripts/photonRaa/PbPb/PbPb_Data_HiForest_Lowpt.list
#OUTMCSKIM=PbPb_Data_photonRaaSkim_Lowpt.root
#CONFIG=./CutConfigurations/photonRaaLowpt.conf
#time ./ForestSkimmers/photons/photonRaaSkim_workingOn.exe ${CONFIG} ${INFILE} ${OUTDIR}/${OUTMCSKIM} > ${OUTDIR}/${OUTMCSKIM}.log || echo "ERROR"
#
#
#echo "### pp DATA ###"
