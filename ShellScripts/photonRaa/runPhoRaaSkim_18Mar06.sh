...
OUTMCSKIM=pp_MC_photonRaaSkim_nonGED.root
time ./ForestSkimmers/photons/photonRaaSkim_workingOn_ppNonGED.exe ./CutConfigurations/photonRaa_mc.conf ${INFILE} ${OUTDIR}/${OUTMCSKIM} > ${OUTDIR}/${OUTMCSKIM}.log || echo "ERROR"

INFILE=./ShellScripts/photonRaa/pp_EmEnrMC_HiForest_v1.list
OUTMCSKIM=pp_EmEnrMC_photonRaaSkim_nonGED.root
time ./ForestSkimmers/photons/photonRaaSkim_workingOn_ppNonGED.exe ./CutConfigurations/photonRaa_mc.conf ${INFILE} ${OUTDIR}/${OUTMCSKIM} 1 > ${OUTDIR}/${OUTMCSKIM}.log || echo "ERROR"
