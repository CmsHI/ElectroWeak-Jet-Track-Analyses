...
do
  ...
  then
    echo $inputFile | sed "s,root://xrootd.cmsaf.mit.edu//store,/mnt/T2_US_MIT/hadoop/cms/store,g"
  else
    sed -i "s,root://xrootd.cmsaf.mit.edu//store,/mnt/T2_US_MIT/hadoop/cms/store,g" $inputFile
  fi
done
