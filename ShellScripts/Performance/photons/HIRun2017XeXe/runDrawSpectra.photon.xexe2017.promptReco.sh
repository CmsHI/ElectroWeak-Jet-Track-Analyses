...
outputFiles=(
$outDirBase"/Configurations/photons/HIRun2017XeXe/spectra_photon_"$outputSuffix".root"
$outDirBase"/Configurations/photons/HIRun2017XeXe/spectra_photon_nonGED_"$outputSuffix".root"
);
