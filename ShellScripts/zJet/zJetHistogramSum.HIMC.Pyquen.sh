...
####################
configFile=$config_histSum_HI_MC_Pyquen

inputHistDir=$EWJTAOUT"/zJet20160715/"
inputHistPrefixZEE=$inputHistDir$hist_HI_ZEE_MC_Pyquen_Prefix
inputHistPrefixZMM=$inputHistDir$hist_HI_ZMM_MC_Pyquen_Prefix
inputZEE=$inputHistPrefixZEE".root"
inputZMM=$inputHistPrefixZMM".root"

outputPrefix=$outputHistSumDir$histSum_HI_MC_Pyquen_Prefix
...
DO_SYS_ZEE=$DO_SYSVAR_HI_ZEE_MC_Pyquen
DO_SYS_ZMM=$DO_SYSVAR_HI_ZMM_MC_Pyquen
