...
####################
echo "### HISTOGRAM STEP"
echo "## zJetHistogram HI MC Pythia ZEE"
####################
configFile=$config_HI_ZEE_MC_Pythia

outputSkimPrefix=$skim_HI_ZEE_MC_Pythia_Prefix
outputSkim=$outputSkimDir$outputSkimPrefix".root"
inputHist=$outputSkim

outputHistPrefix=$hist_HI_ZEE_MC_Pythia_Prefix
...
####################
DO_SYSVAR=$DO_SYSVAR_HI_ZEE_MC_Pythia
