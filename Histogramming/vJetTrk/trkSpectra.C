...
void trkSpectra(std::string configFile, std::string inputFile, std::string outputFile)
{
    ...
    std::cout << "  ignore gen-level electrons or tracks matched to a PF electron with pT > " << skipElePt << std::endl;
    std::cout << "skipMuPt  = " << skipMuPt << std::endl;
    std::cout << "  ignore gen-level muons or tracks matched to a PF muon with pT > " << skipMuPt << std::endl;
    std::cout << "skipEvtElePt = " << skipEvtElePt << std::endl;
    std::cout << "  ignore events containing a gen-level electron with pT > " << skipEvtElePt << std::endl;
    std::cout << "skipEvtMuPt  = " << skipEvtMuPt << std::endl;
    std::cout << "  ignore events containing a gen-level muon with pT > " << skipEvtMuPt << std::endl;
    std::cout << "skipEvtTauPt = " << skipEvtTauPt << std::endl;
    std::cout << "  ignore events containing a gen-level tau with pT > " << skipEvtTauPt << std::endl;
    std::cout << "skipEvtTauNuPt = " << skipEvtTauNuPt << std::endl;
    std::cout << "  ignore events containing a gen-level tau neutrino with pT > " << skipEvtTauNuPt << std::endl;
    std::cout << "excludeConeElePt = " << excludeConeElePt << std::endl;
    std::cout << "excludeConeEleR = " << excludeConeEleR << std::endl;
    std::cout << "  ignore particles that are within dR = " << excludeConeEleR << " of a gen-level electron with pt > " << excludeConeElePt << std::endl;
    std::cout << "excludeConeMuPt = " << excludeConeMuPt << std::endl;
    std::cout << "excludeConeMuR = " << excludeConeMuR << std::endl;
    std::cout << "  ignore particles that are within dR = " << excludeConeMuR << " of a gen-level muon with pt > " << excludeConeMuPt << std::endl;
