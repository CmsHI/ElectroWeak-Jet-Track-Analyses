        ...
        for (int c=0; c<columns; ++c) {
            ...
            for (std::size_t l=0; l<(std::size_t)nHistogram_names_Tmp; ++l) {
                ...
                if (generic[l]->InheritsFrom(TH1D::Class())) {
                    ...
                    histograms[l]->SetAxisRange(0.5 + 0.001, 4.5 - 0.001, "X");
            ...
            if (c + r == 0) {
                ...
                tiler->draw_latex_on_frame(0.04, 0.96 - cms_latex_size * 0.89, "Preliminary", 5, cms_latex_size * 0.81, 13, c, r);
            }
