...
public :
    ...
    static double get_unc_stat_glbtrk_p(double pt, double eta, int cent);
    static double get_unc_stat_glbtrk_m(double pt, double eta, int cent);
    ...
    static double get_unc_sys_glbtrk_p(double pt, double eta, int cent);
    static double get_unc_sys_glbtrk_m(double pt, double eta, int cent);
...
double muonTnP::get_unc(int unc_index, double pt, double eta, int cent)
{
    if (unc_index > 0) {
        ...
        else if (unc_index == MUONTNP::k_stat_trk_p) {
            return get_unc_stat_glbtrk_p(pt, eta, cent);
        }
        else if (unc_index == MUONTNP::k_stat_trk_m) {
            return get_unc_stat_glbtrk_m(pt, eta, cent);
        }
        ...
        else if (unc_index == MUONTNP::k_sys_trk_p) {
            return get_unc_sys_glbtrk_p(pt, eta, cent);
        }
        else if (unc_index == MUONTNP::k_sys_trk_m) {
            return get_unc_sys_glbtrk_m(pt, eta, cent);
        }
...
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, 0) * tnp_weight_muid_pbpb(eta, 1) * tnp_weight_trig_pbpb(pt, eta, cent, 0) / get_weight_nom(pt, eta, cent));
}

double muonTnP::get_unc_stat_id_m(double pt, double eta, int cent)
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, 0) * tnp_weight_muid_pbpb(eta, 2) * tnp_weight_trig_pbpb(pt, eta, cent, 0) / get_weight_nom(pt, eta, cent));
}

double muonTnP::get_unc_stat_glbtrk_p(double pt, double eta, int cent)
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, 1) * tnp_weight_muid_pbpb(eta, 0) * tnp_weight_trig_pbpb(pt, eta, cent, 0) / get_weight_nom(pt, eta, cent));
}

double muonTnP::get_unc_stat_glbtrk_m(double pt, double eta, int cent)
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, 2) * tnp_weight_muid_pbpb(eta, 0) * tnp_weight_trig_pbpb(pt, eta, cent, 0) / get_weight_nom(pt, eta, cent));
}

double muonTnP::get_unc_stat_trig_p(double pt, double eta, int cent)
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, 0) * tnp_weight_muid_pbpb(eta, 0) * tnp_weight_trig_pbpb(pt, eta, cent, 1) / get_weight_nom(pt, eta, cent));
}

double muonTnP::get_unc_stat_trig_m(double pt, double eta, int cent)
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, 0) * tnp_weight_muid_pbpb(eta, 0) * tnp_weight_trig_pbpb(pt, eta, cent, 2) / get_weight_nom(pt, eta, cent));
}
...
double muonTnP::get_unc_sys_glbtrk_p(double pt, double eta, int cent)
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, -1) * tnp_weight_muid_pbpb(eta, 0) * tnp_weight_trig_pbpb(pt, eta, cent, 0) / get_weight_nom(pt, eta, cent));
}

double muonTnP::get_unc_sys_glbtrk_m(double pt, double eta, int cent)
{
    return (tnp_weight_glbtrk_pbpb(eta, cent, -2) * tnp_weight_muid_pbpb(eta, 0) * tnp_weight_trig_pbpb(pt, eta, cent, 0) / get_weight_nom(pt, eta, cent));
}
