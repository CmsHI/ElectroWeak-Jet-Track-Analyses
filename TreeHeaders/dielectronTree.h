...
void dielectron::setupDiElectronTree(TTree *t)
{
    ...
    if (t->GetBranch("eleCharge_2"))  t->SetBranchAddress("eleCharge_2", &eleCharge_2, &b_eleCharge_2);
    if (t->GetBranch("eleChargeConsistent_2"))  t->SetBranchAddress("eleChargeConsistent_2", &eleChargeConsistent_2, &b_eleChargeConsistent_2);
    if (t->GetBranch("eleEn_2"))  t->SetBranchAddress("eleEn_2", &eleEn_2, &b_eleEn_2);
    if (t->GetBranch("eleD0_2"))  t->SetBranchAddress("eleD0_2", &eleD0_2, &b_eleD0_2);
    if (t->GetBranch("eleDz_2"))  t->SetBranchAddress("eleDz_2", &eleDz_2, &b_eleDz_2);
    if (t->GetBranch("eleD0Err_2"))  t->SetBranchAddress("eleD0Err_2", &eleD0Err_2, &b_eleD0Err_2);
    if (t->GetBranch("eleDzErr_2"))  t->SetBranchAddress("eleDzErr_2", &eleDzErr_2, &b_eleDzErr_2);
    if (t->GetBranch("eleTrkPt_2"))  t->SetBranchAddress("eleTrkPt_2", &eleTrkPt_2, &b_eleTrkPt_2);
    if (t->GetBranch("eleTrkEta_2"))  t->SetBranchAddress("eleTrkEta_2", &eleTrkEta_2, &b_eleTrkEta_2);
    if (t->GetBranch("eleTrkPhi_2"))  t->SetBranchAddress("eleTrkPhi_2", &eleTrkPhi_2, &b_eleTrkPhi_2);
    if (t->GetBranch("eleTrkCharge_2"))  t->SetBranchAddress("eleTrkCharge_2", &eleTrkCharge_2, &b_eleTrkCharge_2);
    if (t->GetBranch("eleTrkChi2_2"))  t->SetBranchAddress("eleTrkChi2_2", &eleTrkChi2_2, &b_eleTrkChi2_2);
    if (t->GetBranch("eleTrkNdof_2"))  t->SetBranchAddress("eleTrkNdof_2", &eleTrkNdof_2, &b_eleTrkNdof_2);
    if (t->GetBranch("eleTrkNormalizedChi2_2"))  t->SetBranchAddress("eleTrkNormalizedChi2_2", &eleTrkNormalizedChi2_2, &b_eleTrkNormalizedChi2_2);
    if (t->GetBranch("elePt_2"))  t->SetBranchAddress("elePt_2", &elePt_2, &b_elePt_2);
    if (t->GetBranch("eleEta_2"))  t->SetBranchAddress("eleEta_2", &eleEta_2, &b_eleEta_2);
    if (t->GetBranch("elePhi_2"))  t->SetBranchAddress("elePhi_2", &elePhi_2, &b_elePhi_2);
    if (t->GetBranch("eleSCEn_2"))  t->SetBranchAddress("eleSCEn_2", &eleSCEn_2, &b_eleSCEn_2);
    if (t->GetBranch("eleESEn_2"))  t->SetBranchAddress("eleESEn_2", &eleESEn_2, &b_eleESEn_2);
    if (t->GetBranch("eleSCEta_2"))  t->SetBranchAddress("eleSCEta_2", &eleSCEta_2, &b_eleSCEta_2);
    if (t->GetBranch("eleSCPhi_2"))  t->SetBranchAddress("eleSCPhi_2", &eleSCPhi_2, &b_eleSCPhi_2);
    if (t->GetBranch("eleSCRawEn_2"))  t->SetBranchAddress("eleSCRawEn_2", &eleSCRawEn_2, &b_eleSCRawEn_2);
    if (t->GetBranch("eleSCEtaWidth_2"))  t->SetBranchAddress("eleSCEtaWidth_2", &eleSCEtaWidth_2, &b_eleSCEtaWidth_2);
    if (t->GetBranch("eleSCPhiWidth_2"))  t->SetBranchAddress("eleSCPhiWidth_2", &eleSCPhiWidth_2, &b_eleSCPhiWidth_2);
    if (t->GetBranch("eleHoverE_2"))  t->SetBranchAddress("eleHoverE_2", &eleHoverE_2, &b_eleHoverE_2);
    if (t->GetBranch("eleEoverP_2"))  t->SetBranchAddress("eleEoverP_2", &eleEoverP_2, &b_eleEoverP_2);
    if (t->GetBranch("eleEoverPInv_2"))  t->SetBranchAddress("eleEoverPInv_2", &eleEoverPInv_2, &b_eleEoverPInv_2);
    if (t->GetBranch("eleBrem_2"))  t->SetBranchAddress("eleBrem_2", &eleBrem_2, &b_eleBrem_2);
    if (t->GetBranch("eledEtaAtVtx_2"))  t->SetBranchAddress("eledEtaAtVtx_2", &eledEtaAtVtx_2, &b_eledEtaAtVtx_2);
    if (t->GetBranch("eledPhiAtVtx_2"))  t->SetBranchAddress("eledPhiAtVtx_2", &eledPhiAtVtx_2, &b_eledPhiAtVtx_2);
    if (t->GetBranch("eleSigmaIEtaIEta_2"))  t->SetBranchAddress("eleSigmaIEtaIEta_2", &eleSigmaIEtaIEta_2, &b_eleSigmaIEtaIEta_2);
    if (t->GetBranch("eleSigmaIEtaIEta_2"))  t->SetBranchAddress("eleSigmaIEtaIEta_2012_2", &eleSigmaIEtaIEta_2012_2, &b_eleSigmaIEtaIEta_2012_2);
    if (t->GetBranch("eleSigmaIPhiIPhi_2"))  t->SetBranchAddress("eleSigmaIPhiIPhi_2", &eleSigmaIPhiIPhi_2, &b_eleSigmaIPhiIPhi_2);
    if (t->GetBranch("eleMissHits_2"))  t->SetBranchAddress("eleMissHits_2", &eleMissHits_2, &b_eleMissHits_2);
    if (t->GetBranch("eleESEffSigmaRR_2"))  t->SetBranchAddress("eleESEffSigmaRR_2", &eleESEffSigmaRR_2, &b_eleESEffSigmaRR_2);
    if (t->GetBranch("elePFChIso_2"))  t->SetBranchAddress("elePFChIso_2", &elePFChIso_2, &b_elePFChIso_2);
    if (t->GetBranch("elePFPhoIso_2"))  t->SetBranchAddress("elePFPhoIso_2", &elePFPhoIso_2, &b_elePFPhoIso_2);
    if (t->GetBranch("elePFNeuIso_2"))  t->SetBranchAddress("elePFNeuIso_2", &elePFNeuIso_2, &b_elePFNeuIso_2);
    if (t->GetBranch("elePFPUIso_2"))  t->SetBranchAddress("elePFPUIso_2", &elePFPUIso_2, &b_elePFPUIso_2);
    if (t->GetBranch("eleBC1E_2"))  t->SetBranchAddress("eleBC1E_2", &eleBC1E_2, &b_eleBC1E_2);
    if (t->GetBranch("eleBC1Eta_2"))  t->SetBranchAddress("eleBC1Eta_2", &eleBC1Eta_2, &b_eleBC1Eta_2);
    if (t->GetBranch("eleBC2E_2"))  t->SetBranchAddress("eleBC2E_2", &eleBC2E_2, &b_eleBC2E_2);
    if (t->GetBranch("eleBC2Eta_2"))  t->SetBranchAddress("eleBC2Eta_2", &eleBC2Eta_2, &b_eleBC2Eta_2);
