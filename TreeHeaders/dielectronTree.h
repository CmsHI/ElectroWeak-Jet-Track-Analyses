    ...
    for(int i=0; i<tdielectron.nEle_out; ++i)
    {
        for(int j=i+1; j<tdielectron.nEle_out; ++j)
        {
            if (doSizeCheck) {
                ...
                if(tggHiNtuplizer.eleCharge->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleCharge_2_out.push_back(tggHiNtuplizer.eleCharge->at(i));
                if(tggHiNtuplizer.eleChargeConsistent->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleChargeConsistent_2_out.push_back(tggHiNtuplizer.eleChargeConsistent->at(i));
                if(tggHiNtuplizer.eleEn->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleEn_2_out.push_back(tggHiNtuplizer.eleEn->at(i));
                if(tggHiNtuplizer.eleD0->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleD0_2_out.push_back(tggHiNtuplizer.eleD0->at(i));
                if(tggHiNtuplizer.eleDz->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleDz_2_out.push_back(tggHiNtuplizer.eleDz->at(i));
                if(tggHiNtuplizer.eleD0Err->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleD0Err_2_out.push_back(tggHiNtuplizer.eleD0Err->at(i));
                if(tggHiNtuplizer.eleDzErr->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleDzErr_2_out.push_back(tggHiNtuplizer.eleDzErr->at(i));
                if(tggHiNtuplizer.eleTrkPt->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleTrkPt_2_out.push_back(tggHiNtuplizer.eleTrkPt->at(i));
                if(tggHiNtuplizer.eleTrkEta->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleTrkEta_2_out.push_back(tggHiNtuplizer.eleTrkEta->at(i));
                if(tggHiNtuplizer.eleTrkPhi->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleTrkPhi_2_out.push_back(tggHiNtuplizer.eleTrkPhi->at(i));
                if(tggHiNtuplizer.eleTrkCharge->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleTrkCharge_2_out.push_back(tggHiNtuplizer.eleTrkCharge->at(i));
                if(tggHiNtuplizer.eleTrkChi2->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleTrkChi2_2_out.push_back(tggHiNtuplizer.eleTrkChi2->at(i));
                if(tggHiNtuplizer.eleTrkNdof->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleTrkNdof_2_out.push_back(tggHiNtuplizer.eleTrkNdof->at(i));
                if(tggHiNtuplizer.eleTrkNormalizedChi2->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleTrkNormalizedChi2_2_out.push_back(tggHiNtuplizer.eleTrkNormalizedChi2->at(i));
                if(tggHiNtuplizer.elePt->size() == (unsigned)tdielectron.nEle_out)  tdielectron.elePt_2_out.push_back(tggHiNtuplizer.elePt->at(i));
                if(tggHiNtuplizer.eleEta->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleEta_2_out.push_back(tggHiNtuplizer.eleEta->at(i));
                if(tggHiNtuplizer.elePhi->size() == (unsigned)tdielectron.nEle_out)  tdielectron.elePhi_2_out.push_back(tggHiNtuplizer.elePhi->at(i));
                if(tggHiNtuplizer.eleSCEn->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSCEn_2_out.push_back(tggHiNtuplizer.eleSCEn->at(i));
                if(tggHiNtuplizer.eleESEn->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleESEn_2_out.push_back(tggHiNtuplizer.eleESEn->at(i));
                if(tggHiNtuplizer.eleSCEta->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSCEta_2_out.push_back(tggHiNtuplizer.eleSCEta->at(i));
                if(tggHiNtuplizer.eleSCPhi->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSCPhi_2_out.push_back(tggHiNtuplizer.eleSCPhi->at(i));
                if(tggHiNtuplizer.eleSCRawEn->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSCRawEn_2_out.push_back(tggHiNtuplizer.eleSCRawEn->at(i));
                if(tggHiNtuplizer.eleSCEtaWidth->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSCEtaWidth_2_out.push_back(tggHiNtuplizer.eleSCEtaWidth->at(i));
                if(tggHiNtuplizer.eleSCPhiWidth->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSCPhiWidth_2_out.push_back(tggHiNtuplizer.eleSCPhiWidth->at(i));
                if(tggHiNtuplizer.eleHoverE->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleHoverE_2_out.push_back(tggHiNtuplizer.eleHoverE->at(i));
                if(tggHiNtuplizer.eleEoverP->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleEoverP_2_out.push_back(tggHiNtuplizer.eleEoverP->at(i));
                if(tggHiNtuplizer.eleEoverPInv->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleEoverPInv_2_out.push_back(tggHiNtuplizer.eleEoverPInv->at(i));
                if(tggHiNtuplizer.eleBrem->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleBrem_2_out.push_back(tggHiNtuplizer.eleBrem->at(i));
                if(tggHiNtuplizer.eledEtaAtVtx->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eledEtaAtVtx_2_out.push_back(tggHiNtuplizer.eledEtaAtVtx->at(i));
                if(tggHiNtuplizer.eledPhiAtVtx->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eledPhiAtVtx_2_out.push_back(tggHiNtuplizer.eledPhiAtVtx->at(i));
                if(tggHiNtuplizer.eleSigmaIEtaIEta->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSigmaIEtaIEta_2_out.push_back(tggHiNtuplizer.eleSigmaIEtaIEta->at(i));
                if(tggHiNtuplizer.eleSigmaIEtaIEta_2012->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSigmaIEtaIEta_2012_2_out.push_back(tggHiNtuplizer.eleSigmaIEtaIEta_2012->at(i));
                if(tggHiNtuplizer.eleSigmaIPhiIPhi->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleSigmaIPhiIPhi_2_out.push_back(tggHiNtuplizer.eleSigmaIPhiIPhi->at(i));
                if(tggHiNtuplizer.eleMissHits->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleMissHits_2_out.push_back(tggHiNtuplizer.eleMissHits->at(i));
                if(tggHiNtuplizer.eleESEffSigmaRR->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleESEffSigmaRR_2_out.push_back(tggHiNtuplizer.eleESEffSigmaRR->at(i));
                if(tggHiNtuplizer.elePFChIso->size() == (unsigned)tdielectron.nEle_out)  tdielectron.elePFChIso_2_out.push_back(tggHiNtuplizer.elePFChIso->at(i));
                if(tggHiNtuplizer.elePFPhoIso->size() == (unsigned)tdielectron.nEle_out)  tdielectron.elePFPhoIso_2_out.push_back(tggHiNtuplizer.elePFPhoIso->at(i));
                if(tggHiNtuplizer.elePFNeuIso->size() == (unsigned)tdielectron.nEle_out)  tdielectron.elePFNeuIso_2_out.push_back(tggHiNtuplizer.elePFNeuIso->at(i));
                if(tggHiNtuplizer.elePFPUIso->size() == (unsigned)tdielectron.nEle_out)  tdielectron.elePFPUIso_2_out.push_back(tggHiNtuplizer.elePFPUIso->at(i));
                if(tggHiNtuplizer.eleBC1E->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleBC1E_2_out.push_back(tggHiNtuplizer.eleBC1E->at(i));
                if(tggHiNtuplizer.eleBC1Eta->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleBC1Eta_2_out.push_back(tggHiNtuplizer.eleBC1Eta->at(i));
                if(tggHiNtuplizer.eleBC2E->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleBC2E_2_out.push_back(tggHiNtuplizer.eleBC2E->at(i));
                if(tggHiNtuplizer.eleBC2Eta->size() == (unsigned)tdielectron.nEle_out)  tdielectron.eleBC2Eta_2_out.push_back(tggHiNtuplizer.eleBC2Eta->at(i));
                ...
                tdielectron.eleBC1E_2_out.push_back(tggHiNtuplizer.eleBC1E->at(i));
                tdielectron.eleBC1Eta_2_out.push_back(tggHiNtuplizer.eleBC1Eta->at(i));
                tdielectron.eleBC2E_2_out.push_back(tggHiNtuplizer.eleBC2E->at(i));
                tdielectron.eleBC2Eta_2_out.push_back(tggHiNtuplizer.eleBC2Eta->at(i));
